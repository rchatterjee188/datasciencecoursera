...
fileUrl <- "https://hubcdn.arcgis.com/opendata-ui/assets/assets/vendor-6c2aec1db9e05d49f9a6ae4a8a86e217.css" # use href in source code
download.file(fileUrl, destfile = "./testdir/trafficdata.csv", method = "curl") # improve reproducibility. Args: url, destfile, method. curl method is for https (specifically MAC).
...
fileUrl <- "https://hubcdn.arcgis.com/opendata-ui/assets/assets/vendor-6c2aec1db9e05d49f9a6ae4a8a86e217.css"
if (!file.exists("./testdir/crimedata.xlsx")) {
  download.file(fileUrl, destfile = "./testdir/crimedata.xlsx", method = "curl")
  dateDownloadedXL <- date()
}
#library(xlsx)
#cameraData <- read.xlsx("./testdir/crimedata.xlsx", sheetIndex = 1, header = TRUE)
#head(cameraData)
